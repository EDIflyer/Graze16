...
abstract class UnreadWidgetPrefWizard extends AbstractWizard
{
  ...
  UnreadWidgetPrefWizard(Activity owningActivity)
  {
    ...
    SimpleCursorAdapter sca = new SimpleCursorAdapter(owningActivity, R.layout.text_view, c, new String[] { "TITLE" },
    ...
    sca = new SimpleCursorAdapter(owningActivity, R.layout.text_view, c, new String[] { "NAME" }, new int[] { R.id.text_view });
