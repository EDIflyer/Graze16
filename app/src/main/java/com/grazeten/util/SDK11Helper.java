...
public class SDK11Helper
{
   ...
   * 
   * Class viewClass = View.class; Method m = viewClass.getMethod("isHardwareAccelerated", null);
   * 
   * boolean isHardwareAccelerated = false; final String toastMessage = String.format("This screen is %shw accelerated.", (isHardwareAccelerated ? "" :
   * "not ")); Toast.makeText(activity, toastMessage, Toast.LENGTH_LONG).show(); return isHardwareAccelerated; }
   */
}
