...
public class U
{
  ...
  public static String pluralize(int number, String wordSingular)
  {
    ...
    /*
     * String[] numbers = { "no", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten", "eleven", "twelve" }; if (number >
     * numbers.length - 1) return number + " " + wordSingular + "s";
     * 
  ...
  public static final boolean isScreenOn(Context ctx)
  {
    ...
    /*
     * if (pm == null) pm = (PowerManager) ctx.getSystemService(Context.POWER_SERVICE); return pm.isScreenOn();
     */
