...
public class AccountManagementUtilsImplementation implements IAccountManagementUtils
{
  ...
  public void getAuthToken(final Activity waitingActivity, Handler handler, final IAuthenticationCallback callback, String googleAccount)
  {
    ...
    if (false)
      accountManager.getAuthTokenByFeatures(GOOGLE_ACCOUNT_TYPE, "reader", GOOGLE_ACCOUNT, waitingActivity, new Bundle(), null,
  ...
  public void addAccount(Activity owningActivity)
  {
    ...
    try
    {
      ...
      getAccountManager(owningActivity).addAccount(GOOGLE_ACCOUNT_TYPE, null, null, null, owningActivity, null, null);
